    ...
    <div className="max-w-3xl mx-auto px-6 py-12 bg-white shadow-xl rounded-2xl my-2">
      ...
      <div className="p-1">
        ...
        <p className="text-lg text-gray-700">
          Created By: <span className="font-semibold text-gray-800">{story.createdBy.name}</span>
        </p>
        <p className="text-md text-purple-600 mt-1">
          Genre: <span className="font-medium">{story.genre || 'N/A'}</span>
        </p>
      </div>

      {/* Story Content */}
      <div className="space-y-6 text-lg text-gray-800 leading-relaxed mt-6">
